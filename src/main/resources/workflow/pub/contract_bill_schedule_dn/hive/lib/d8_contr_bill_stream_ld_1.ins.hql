...
--Script Name: d8_contr_bill_stream_ld_1.ins.sql
--Inputs:  
--Outputs:
...
--Original Query:
  --DELETE FROM contr_bill_stream_ld WHERE  (contr_bill_stream_id, instance_id) IN  (SELECT contr_bill_stream_id, instance_id    FROM ${TTMMPPDDBB1}.${AAPPLLIIDD1EENNVV}_contr_bill_stream_t2)  
...
--Original Query:
  --LOCK TABLE ${TTMMPPDDBB1}.${AAPPLLIIDD1EENNVV}_contr_bill_stream_t2 FOR ACCESS  INSERT INTO contr_bill_stream_ld (   contr_bill_stream_id   ,instance_id    ,alt_as_of_date_time    ,alt_batch_nbr  ,alt_contract_header_id     ,as_of_date_time    ,batch_nbr  ,billing_amt_ent    ,billing_period_cnt     ,billing_period_uom_cnt     ,billing_period_uom_code    ,billing_seq_nbr    ,billing_stream_end_date    ,billing_stream_start_date  ,contract_header_id     ,contract_line_id   ,created_by_name    ,creation_date_time     ,interface_offset_day_nbr   ,invoice_offset_day_nbr     ,last_update_date_time  ,last_update_login_name     ,last_updated_by_name   ,tran_code ) SELECT      contr_bill_stream_id   ,instance_id    ,alt_as_of_date_time    ,alt_batch_nbr  ,alt_contract_header_id     ,as_of_date_time    ,batch_nbr  ,billing_amt_ent    ,billing_period_cnt     ,billing_period_uom_cnt     ,billing_period_uom_code    ,billing_seq_nbr    ,billing_stream_end_date    ,billing_stream_start_date  ,contract_header_id     ,contract_line_id   ,created_by_name    ,creation_date_time     ,interface_offset_day_nbr   ,invoice_offset_day_nbr     ,last_update_date_time  ,last_update_login_name     ,last_updated_by_name   ,tran_code FROM ${TTMMPPDDBB1}.${AAPPLLIIDD1EENNVV}_contr_bill_stream_t2  
