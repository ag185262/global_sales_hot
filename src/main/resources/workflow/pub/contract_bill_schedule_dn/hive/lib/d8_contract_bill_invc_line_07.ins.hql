...
--Script Name: d8_contract_bill_invc_line_07.ins.sql
--Inputs:  
--Outputs:
...
--Original Query:
  --DELETE FROM contract_bill_invc_line_ld  WHERE (bill_transaction_line_id, instance_id) IN (SELECT bill_transaction_line_id, instance_id     FROM ${TTMMPPDDBB1}.${AAPPLLIIDD1EENNVV}_contract_bill_invc_line_t2     )  
...
--Original Query:
  --LOCK TABLE  ${TTMMPPDDBB1}.${AAPPLLIIDD1EENNVV}_contract_bill_invc_line_t2 FOR ACCESS  INSERT INTO contract_bill_invc_line_ld (     bill_transaction_line_id,   instance_id,    alt_as_of_date_time,    alt_batch_nbr,  as_of_date_time,    batch_nbr,  bill_instance_nbr,  bill_transaction_id,    contract_line_bill_id,  contract_subline_bill_id,   created_by_name,    creation_date_time,     invoice_line_amt_ent,   last_update_date_time,  last_update_login_name,     last_updated_by_name,   tran_code,  cycle_ref_seq_desc,                                                         invoice_date,                                                               invoice_nbr,                                                                invoice_type_code           ) SELECT    bill_transaction_line_id,   instance_id,    alt_as_of_date_time,    alt_batch_nbr,  as_of_date_time,    batch_nbr,  bill_instance_nbr,  bill_transaction_id,    contract_line_bill_id,  contract_subline_bill_id,   created_by_name,    creation_date_time,     invoice_line_amt_ent,   last_update_date_time,  last_update_login_name,     last_updated_by_name,   tran_code,  cycle_ref_seq_desc,                                                         invoice_date,                                                               invoice_nbr,                                                                invoice_type_code                                                       FROM ${TTMMPPDDBB1}.${AAPPLLIIDD1EENNVV}_contract_bill_invc_line_t2  
